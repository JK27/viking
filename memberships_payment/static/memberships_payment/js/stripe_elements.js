...
form.addEventListener('submit', function(ev) {      // When user clicks submit button...
    ...
    $('#payment-form').fadeToggle(100);             // ... hides form...
    ...
    var url = '/memberships_payment/cache_payment_data/';
    ...
    $.post(url, postData).done(function() {         // When view returns 200 response...
        ...
        /* If there is an error posting the data to view just reload the page, 
        the error will be in django messages without charging the user */
        location.reload();
    })
});
